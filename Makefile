...
start:
	...
	@echo "Go to http://localhost:8081 for the demo UI."
	@echo "Go to http://localhost:8081/jaeger/ui for the Jaeger UI."
	@echo "Go to http://localhost:8081/grafana/ for the Grafana UI."
	@echo "Go to http://localhost:8081/loadgen/ for the Load Generator UI."
	@echo "Go to http://localhost:8081/feature/ to change feature flags."
